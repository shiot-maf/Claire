...
**색은 무지개 순서다.** 1단계 빨강 · 2 주황 · 3 노랑 · 4 초록 · 5 파랑 · 6 남색.
...
1. **여섯 단계의 회색값을 서로 19 이상 벌린다.** 무지개 순서대로 고르면
   노랑이 가장 밝고 남색이 가장 어두워 자연히 갈라지지만, 값은 확인하고 정한다.
2. **한 단계 안의 네 챕터는 회색값을 33씩 벌린다.**

배지에는 늘 숫자나 글자가 함께 있다(「CHAPTER 2」, 「3단계」). 색이 완전히
뭉개지는 최악의 복사에서도 어느 쪽인지 읽을 수 있어야 하기 때문이다.

색을 고치면 [`palette.html`](palette.html)의 **「흑백으로 보기」**로 확인한다.
